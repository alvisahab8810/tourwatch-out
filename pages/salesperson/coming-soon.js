...
export default function ComingSoon() {
  ...
  return (
    <SPLayout active="" spData={spData} onLogout={handleLogout}>
      <Head><title>Coming Soon — Tourwatchout</title></Head>
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: "calc(100vh - 54px)", padding: 32, textAlign: "center" }}>
        ...
        <h1 style={{ fontSize: 28, fontWeight: 800, color: "#0f172a", margin: "0 0 12px" }}>Coming Soon</h1>
        <p style={{ fontSize: 15, color: "#64748b", maxWidth: 400, margin: "0 0 28px", lineHeight: 1.7 }}>
