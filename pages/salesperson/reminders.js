...
export default function SPReminders() {
  ...
  return (
    <SPLayout active="Reminders" spData={spData} onLogout={handleLogout}>
      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: "calc(100vh - 54px)", padding: 32, textAlign: "center" }}>
        ...
        <h1 style={{ fontSize: 28, fontWeight: 800, color: "#0f172a", margin: "0 0 12px" }}>Reminders</h1>
        <p style={{ fontSize: 15, color: "#64748b", maxWidth: 420, margin: "0 0 28px", lineHeight: 1.7 }}>
          The Reminders module is under development. Set reminders for calls, follow-ups, and meetings — coming soon.
        </p>
