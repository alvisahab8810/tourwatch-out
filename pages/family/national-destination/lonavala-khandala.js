...
export default function LonavalaKhandala() {
  return (
          ...
          <div className="row align-items-center pt-200">
            <div className="col-md-12 about-contennt">
              <h2 className="fs-64 text-white fw-bold">
                The heaven of earth, Lonavala & Khandala
              </h2>
              <p>
          ...
          <div className="parent-package w-100" id="package">
            <div className="max-800">
              <div className="content-section">
                <h1>Lonavala & Khandala Family Tour Package</h1>
              </div>
                      ...
                      <div className="container">
                        <div className="schedule-list">
                          <div className="schedule-items">
                            ...
                            <div>
                              <h3>Arrival in Mumbai - Lonavala (About 83 Kilometres)</h3>
                              <p className="sche-details">
                                 Arrive in Lonavala from Mumbai. Check into your hotel and take a short break. Visit Karla and Bhaja Caves, famous Buddhist rock-cut caves.
                              </p>
                            </div>
                          </div>
                          <div className="schedule-items">
                            ...
                            <div>
                              <h3>Lonavala Sightseeing & Duke's Nose</h3>
                              <p className="sche-details">
                                 Visit Bhushi Lake, a scenic lake surrounded by hills. Head to Kune Waterfalls for a refreshing experience. Trek to Duke's Nose, an iconic point offering panoramic views. Return hotel and overnight stay.
                              </p>
                            </div>
                          </div>
                          <div className="schedule-items">
                            ...
                            <div>
                              ...
                              <p className="sche-details">
                                Check out from your Lonavala hotel and drive to Khandala (a short distance). Visit Tiger's Point, an amazing vantage point offering stunning views of the valley.  Explore Lohagad Fort, a historical citadel known for its architectural beauty. Enjoy the sunset at Tiger's Point before returning to your Khandala hotel.
                              </p>
                            </div>
                          </div>
                          ...
                          <div className="schedule-items">
                            ...
                            <div>
                              <h3>Departure</h3>
                              <p className="sche-details">
                                 Enjoy a leisurely breakfast at your hotel. Depending on your flight or train schedule, you can revisit a favorite spot in Khandala or explore the surrounding areas. Depart from Khandala and travel back to Mumbai.
                              </p>
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="container">
                        <div className="schedule-list">
                          <div className="schedule-items">
                            ...
                            <div>
                              <h3>
                                Arrival in Mumbai - Lonavala (About 83 Kilometres)
                              </h3>
                              <p className="sche-details">
                                 Arrive in Lonavala from Mumbai. Check into your hotel and take a short break. Visit Karla and Bhaja Caves, famous Buddhist rock-cut caves.
                              </p>
                          ...
                          <div className="schedule-items">
                            ...
                            <div>
                              <h3>
                                 Lonavala Sightseeing & Duke's Nose
                              </h3>
                              <p className="sche-details">
                                 Visit Bhushi Lake, a scenic lake surrounded by hills. Head to Kune Waterfalls for a refreshing experience. Trek to Duke's Nose, an iconic point offering panoramic views. Return hotel and overnight stay.
                              </p>
                          ...
                          <div className="schedule-items">
                            ...
                            <div>
                              <h3>
                                {" "}
                                 Khandala Exploration & Lohagad Fort
                              </h3>
                              <p className="sche-details">
                                 Check out from your Lonavala hotel and drive to Khandala (a short distance). Visit Tiger's Point, an amazing vantage point offering stunning views of the valley.  Explore Lohagad Fort, a historical citadel known for its architectural beauty. Enjoy the sunset at Tiger's Point before returning to your Khandala hotel.
                              </p>
            ...
            <div className="max-400 mobile-none">
              ...
              <div className="table-contents">
                <Link href="#package">Lonavala & Khandala Packages</Link>

                <Link href="#about-us">About Lonavala & Khandala</Link>

                <Link href="#headingTwo">Lonavala & Khandala Bucket List</Link>

                <Link href="#headingThree">Lonavala & Khandala FAQ’s </Link>

                <Link href="#location">Lonavala & Khandala Location</Link>
                ...
                >
                  <div className="accordion-body bg-prime">
                    <div className="about-items">
                      <p>
                        Lonavala & Khandala, often referred to as "Paradise on Earth,"
                        is a breathtaking region nestled in the northern part of
                        the Indian subcontinent. Renowned for its stunning
                        natural beauty, Lonavala & Khandala is characterized by its
