...
const QuotationSchema = new mongoose.Schema({
  ...
  flights: [{
    ...
    // Connecting flight after outward layover (round-trip only)
    hasOnwardConn:       { type: Boolean, default: false },
    onwardConnPnr:       { type: String,  default: "" },
    onwardConnFlightNo:  { type: String,  default: "" },
    onwardConnDepCity:   { type: String,  default: "" },
    onwardConnDepIATA:   { type: String,  default: "" },
    onwardConnDepDate:   { type: String,  default: "" },
    onwardConnDepTime:   { type: String,  default: "" },
    onwardConnArrCity:   { type: String,  default: "" },
    onwardConnArrIATA:   { type: String,  default: "" },
    onwardConnArrDate:   { type: String,  default: "" },
    onwardConnArrTime:   { type: String,  default: "" },
    onwardConnPax:       { type: Number,  default: 0 },
    onwardConnPrice:     { type: Number,  default: 0 },
    // Connecting flight after return layover (round-trip only)
    hasReturnConn:       { type: Boolean, default: false },
    returnConnPnr:       { type: String,  default: "" },
    returnConnFlightNo:  { type: String,  default: "" },
    returnConnDepCity:   { type: String,  default: "" },
    returnConnDepIATA:   { type: String,  default: "" },
    returnConnDepDate:   { type: String,  default: "" },
    returnConnDepTime:   { type: String,  default: "" },
    returnConnArrCity:   { type: String,  default: "" },
    returnConnArrIATA:   { type: String,  default: "" },
    returnConnArrDate:   { type: String,  default: "" },
    returnConnArrTime:   { type: String,  default: "" },
    returnConnPax:       { type: Number,  default: 0 },
    returnConnPrice:     { type: Number,  default: 0 },
  }],
