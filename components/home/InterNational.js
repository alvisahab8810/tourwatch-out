            ...
            className="swiper mySwiper4 pt-80">
                <SwiperSlide className="swiper-slide">
                    ...
                    <div className="desti-main">
                        ...
                        <p>
                            Dubai - Abudhabi is a tropical paradise, renowned for its stunning
                ...
                <SwiperSlide className="swiper-slide">
                    ...
                    <div className="desti-main">
                        ...
                        <h3>Bali</h3>
                        <p>
                            Bali is a dynamic city-state, celebrated for its modern
                ...
                <SwiperSlide className="swiper-slide">
                    ...
                    <div className="desti-main">
                        ...
                        <h3>Singapore</h3>
                        <p>
                            Singapore is a diverse country, known for its stunning
