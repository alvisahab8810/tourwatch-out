...
export default function CoupleDubaiPackages() {
  return (
    <section className="family-dubai-packages couple-dubai-packages">
      <div className="mini-container1">
        <div className="section-header">
          <p className="section-subtitle">Recomended</p>
          <h2 className="section-title">
            <span className="highlight">Couple Dubai </span> Packages
          </h2>
        </div>
          ...
          <div className="new-desti-card f-dubai-card">
            <div className="f-dubai-main-card">
              ...
              <div className="f-dubai-contanetbx">
                ...
                <Link
                  href="/dubai/dubai-family?tab=economy"
          ...
          <div className="new-desti-card f-dubai-card1">
            <div className="f-dubai-main-card">
              <div className="header">
                <div>
              ...
              <div className="f-dubai-contanetbx">
                ...
                <Link href="/dubai/dubai-family?tab=deluxe">
                  <div className="price-section">
                    <div className="price-info">
                      ...
                      <p className="new-price">₹160,000</p>
                    </div>
                  </div>
                </Link>
                ...
                <Link
                  href="/dubai/dubai-family?tab=deluxe"
                  className="package-button interactive"
                >
                  View Package
                </Link>
          ...
          <div className="new-desti-card f-dubai-card2">
            <div className="f-dubai-main-card">
              <div className="header">
                <div>
              ...
              <div className="f-dubai-contanetbx">
                ...
                <Link
                  href="/dubai/dubai-family?tab=premium"
                  className="package-button interactive"
                >
                  View Package
                </Link>
